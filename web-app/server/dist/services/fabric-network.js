...
exports.enrollAdmin = exports.register = exports.createUser = exports.invoke = exports.connectToNetwork = exports.getCA = exports.userExists = exports.getCaInfo = exports.getAffiliation = exports.getCAAdminByOrg = exports.getAdminByOrg = exports.getTypeByOrg = exports.connectToGateway = exports.connectToWallet = void 0;
...
function getCAAdminByOrg(orgName) {
    return orgName == "Org1" ? "Org1 CA Admin" : "Org2 CA Admin";
}
exports.getCAAdminByOrg = getCAAdminByOrg;
...
function getCaInfo(orgName) {
    return orgName == "Org1"
        ? {
            url: config.ccpOrg1.certificateAuthorities["org1ca-api.127-0-0-1.nip.io:8080"].url,
            name: "Org1 CA Admin",
        }
        : {
            url: config.ccpOrg2.certificateAuthorities["org2ca-api.127-0-0-1.nip.io:8080"].url,
            name: "Org2 CA Admin",
        };
}
